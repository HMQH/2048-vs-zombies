function GameManager(size, InputManager, Actuator, StorageManager) {
  ...
  this.firstAudio = new Audio('./audio/Graze the Roof.mp3');
  this.secondAudio = new Audio('./audio/Watery Graves.mp3');
...
GameManager.prototype.startSpawningZombies = function () {
  ...
  const spawn = () => {
    ...
    setTimeout(spawn, this.spawnRate);
  };
